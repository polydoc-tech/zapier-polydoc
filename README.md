...
- **Generate E-Invoice** - Factur-X or ZUGFeRD, profiles `basic`, `en16931` and `extended`. Setup walkthrough and a complete worked example: [docs/einvoice.md](./docs/einvoice.md).
